 ...
 * 类详细说明.
 * <p>
 * Copyright: Copyright (c) 2017年2月7日 上午11:46:01
 * <p>
 ...
 * @version 1.0.0
 */
public class QueryControlParamMessage extends AbstractMessage {
	 /**
     * 构造器，初始化各变量 初始化各字符串变量目的是防止空指针异常
     */
    public QueryControlParamMessage(Header header)
    {
        super(header);
        this.getHeader().setCommand(QUERY_CONTROL_PARAM);

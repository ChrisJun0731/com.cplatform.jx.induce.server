 ...
 * 类详细说明.
 * <p>
 * Copyright: Copyright (c) 2017年2月7日 下午5:04:29
 * <p>
 ...
 * @version 1.0.0
 */
public class DetectionPointMessage extends AbstractMessage {

	 /**
     * 构造器，初始化各变量 初始化各字符串变量目的是防止空指针异常
     */
    public DetectionPointMessage(Header header)
    {
        super(header);
        this.getHeader().setCommand(DETECTION_POINT);

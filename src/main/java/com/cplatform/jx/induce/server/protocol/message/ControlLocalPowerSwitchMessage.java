 ...
 * 类详细说明.
 * <p>
 * Copyright: Copyright (c) 2017年2月10日 下午2:43:38
 * <p>
 ...
 * @version 1.0.0
 */
public class ControlLocalPowerSwitchMessage extends AbstractMessage {
     ...
     */
    public ControlLocalPowerSwitchMessage(Header header)
    {
        super(header);
        this.getHeader().setCommand(CONTROL_LOCAL_POWER_SWITCH);

 ...
 * 类详细说明.
 * <p>
 * Copyright: Copyright (c) 2017年2月16日 下午5:15:12
 * <p>
 ...
 * @version 1.0.0
 */
public class QueryDetectionPointMessage extends AbstractMessage {

	 /**
     * 构造器，初始化各变量 初始化各字符串变量目的是防止空指针异常
     */
    public QueryDetectionPointMessage(Header header)
    {
        super(header);
        this.getHeader().setCommand(QUERY_DETECTION_POINT_PARAM);
        this.getHeader().setTotalLength(7);//有消息内容

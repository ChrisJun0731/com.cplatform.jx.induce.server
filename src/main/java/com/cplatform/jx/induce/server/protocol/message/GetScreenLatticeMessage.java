 ...
 * 类详细说明.
 * <p>
 * Copyright: Copyright (c) 2017年2月10日 下午2:36:48
 * <p>
 ...
 * @version 1.0.0
 */
public class GetScreenLatticeMessage extends AbstractMessage {

	 /**
     * 构造器，初始化各变量 初始化各字符串变量目的是防止空指针异常
     */
    public GetScreenLatticeMessage(Header header)
    {
        super(header);
        this.getHeader().setCommand(GET_SCREEN_LATTICE);

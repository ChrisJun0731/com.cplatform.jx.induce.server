 ...
 * 类详细说明.
 * <p>
 * Copyright: Copyright (c) 2017年2月8日 上午9:54:14
 * <p>
 ...
 * @version 1.0.0
 */
public class ReadBadPointMessage extends AbstractMessage {


	 /**
    * 构造器，初始化各变量 初始化各字符串变量目的是防止空指针异常
    */
   public ReadBadPointMessage(Header header)
   {
       super(header);
       this.getHeader().setCommand(READ_BAD_POINT);
